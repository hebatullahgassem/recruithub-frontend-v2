      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            ...
            <Box sx={{ width: "100%", mt: 1 }}>
              ...
              {talent.email && (
                <InfoItem>
                  <Email color="primary" sx={{ mr: 1, fontSize: 24 }} />
                  <Typography variant="body1" sx={{ maxWidth: '100%', overflow: 'hidden', whiteSpace: 'nowrap' }}>
                    <Link
        ...
        <Grid item xs={12} md={8}>
          ...
          {talent.about && talent.about !== "about" && (
            <Box sx={{ mb: 5 }}>
              <SectionHeader variant="h5">About</SectionHeader>
              <Typography
                variant="body1"
                sx={{
                  lineHeight: 1.8,
          ...
          {skills.length > 0 && (
            <Box sx={{ mb: 5 }}>
              <SectionHeader variant="h5">Skills & Expertise</SectionHeader>
          ...
          {/* {talent.national_id_img && (
            <Box sx={{ mb: 4 }}>
              <SectionHeader variant="h5">Identity Verification</SectionHeader>
              <Box
                sx={{
                  display: "flex",
                  justifyContent: "center",
